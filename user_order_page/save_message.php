...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $worker_id = isset($_POST['sender']) ? $conn->real_escape_string($_POST['sender']) : null; // Assuming "sender" maps to user_id
    ...
    if ($content && $userID) {
        ...
        $sql = "INSERT INTO messages (user_id, worker_id, content, flag, order_id) VALUES ('$userID', $worker_id, '$content', $flag, $order_id)";
