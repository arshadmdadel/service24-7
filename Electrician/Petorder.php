  ...
  <header>
    ...
    <div class="order-form">
        ...
        <form id="orderForm">
            ...
            <input type="date" id="startDate" onchange="updateSummary()" required>
            </div>
            <label for="endDate">End Date</label>
            <input type="date" id="endDate" onchange="updateSummary()" required>
            <div>

            </div>
            <label for="pickupLocation">Pickup Location</label>
            <input type="text" id="pickupLocation" placeholder="Enter location" onchange="updateSummary()" required>
